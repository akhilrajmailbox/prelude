...
#   Defaults to 'https://github.com/akhilrajmailbox/prelude.git'
# -i/--into
...
usage() {
    ...
    printf "  \t \t \t \t Defaults to 'https://github.com/akhilrajmailbox/prelude.git'.\n"
...
[ -z "$PRELUDE_URL" ] && PRELUDE_URL="https://github.com/akhilrajmailbox/prelude.git"
